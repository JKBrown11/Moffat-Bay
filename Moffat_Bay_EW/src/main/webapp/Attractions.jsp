...
<!--     <link rel="stylesheet" href="CSS/attractions2.css"> -->
</head>
<body>
    ...
    <div class="attraction-container">
        ...
        <div class="attraction">
            ...
            <p>Embark on an amazing adventure with hiking at Moffat Bay Beach Resort, where nature's beauty meets the thrill of exploration! 
                Our scenic trails wind through lush forests, offering panoramic views of the sparkling bay and pristine wilderness. Whether you're
                a seasoned hiker or a casual explorer, you'll find paths tailored to your pace, leading to hidden waterfalls, serene overlooks, and 
        ...
        <div class="attraction">
            ...
            <p>Set out on an unforgettable kayaking adventure at Moffat Bay Beach Resort! Glide through serene, crystal-clear waters as you explore hidden coves, 
                picturesque shorelines, and lush vegetation brimming with wildlife. Perfect for nature lovers and thrill-seekers alike, kayaking at Moffat 
                Bay offers a tranquil escape with breathtaking views and a chance to connect with the great outdoors. Whether you are paddling solo or sharing the 
        ...
        <div class="attraction">
            ...
            <p>Experience the awe-inspiring majesty of the ocean with whale watching at Moffat Bay Beach Resort! Set sail on a breathtaking adventure 
                to witness these gentle giants in their natural habitat, as they breach, tail slap, and play in the sparkling waters. Perfect for nature
                enthusiasts and families, our expertly guided tours ensure an unforgettable encounter with these magnificent creatures, all while 
                enjoying the stunning coastal scenery. You do not want to miss this once-in-a-lifetime opportunity to connect with the wonders of the deep 
        ...
        <div class="attraction">
            ...
            <p>Dive into a world of wonder with scuba diving at Moffat Bay Beach Resort! Explore vibrant coral reefs teeming with marine life, 
                including tropical fish, sea turtles, and mesmerizing underwater landscapes. Perfect for both beginners and experienced divers, our 
                guided excursions offer a safe and exhilarating way to uncover the hidden treasures of the ocean. With crystal-clear waters and professional 
                instructors by your side, each dive promises an unforgettable adventure beneath the waves. Make your stay at Moffat Bay Resort truly 
                extraordinary by discovering the breathtaking beauty of the underwater world!</p>
        </div>
    </div>
</body>
</html>